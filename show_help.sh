...
USAGES["draw_border.sh"]="Usage: draw_border.sh <hexcolor|transparent> [--size=128] [--radius=20] <path.png>\nEdits the PNG in place. If path is relative, it is resolved relative to the project root."
USAGES["draw_square.sh"]="Usage: draw_square.sh <hexcolor|transparent> [--size=196] <path.png>\nCreates the PNG exactly at the given path. If path is relative, it is resolved relative to the project root."
USAGES["draw_text.sh"]="Usage: draw_text.sh [--text=hello] [--text_color=00FF00] [--text_align=top|center|bottom] [--text_font=Roboto.ttf] [--text_size=16] [--text_offset=x,y] <path.png>\nEdits the PNG in place. If path is relative, it is resolved relative to the project root."
USAGES["draw_optimize.sh"]="Usage: draw_optimize.sh [-c|--color <n<=256>] <path.png>\nEdits the PNG in place. If path is relative, it is resolved relative to the project root."
USAGES["draw_mdi.sh"]="Usage: draw_mdi.sh <mdi:name> <hexcolor> [--size=128] <path.png>\nEdits/creates the target PNG. If path is relative, it is resolved relative to the project root."
