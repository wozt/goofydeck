// Wrapper binary: draw_over_rectangle delegates to draw_over.
// draw_over itself is size-agnostic and already supports rectangle tiles.
...
int main(int argc, char **argv) {
    ...
    char tool[PATH_MAX];
    fd_snprintf_checked(tool, sizeof(tool), "tool(draw_over)", "%s/icons/draw_over", root);
