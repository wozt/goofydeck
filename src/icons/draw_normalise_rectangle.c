// Typo-compat wrapper: draw_normalise_rectangle -> draw_normalize_rectangle.
...
int main(int argc, char **argv) {
    ...
    char tool[PATH_MAX];
    fd_snprintf_checked(tool, sizeof(tool), "tool(draw_normalize_rectangle)", "%s/icons/draw_normalize_rectangle", root);
