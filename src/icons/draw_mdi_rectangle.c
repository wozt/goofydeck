// Wrapper binary: draw_mdi_rectangle delegates to draw_mdi.
// draw_mdi composites into the existing PNG and supports non-square targets.
...
int main(int argc, char **argv) {
    ...
    char tool[PATH_MAX];
    fd_snprintf_checked(tool, sizeof(tool), "tool(draw_mdi)", "%s/icons/draw_mdi", root);
