// Wrapper binary: draw_text_rectangle delegates to draw_text.
// draw_text supports wide rectangle tiles (e.g. 442x196).
...
int main(int argc, char **argv) {
    ...
    char tool[PATH_MAX];
    fd_snprintf_checked(tool, sizeof(tool), "tool(draw_text)", "%s/icons/draw_text", root);
