// Typo-compat wrapper: draw_optimize_recangle -> draw_optimize_rectangle.
...
int main(int argc, char **argv) {
    ...
    char tool[PATH_MAX];
    fd_snprintf_checked(tool, sizeof(tool), "tool(draw_optimize_rectangle)", "%s/icons/draw_optimize_rectangle", root);
